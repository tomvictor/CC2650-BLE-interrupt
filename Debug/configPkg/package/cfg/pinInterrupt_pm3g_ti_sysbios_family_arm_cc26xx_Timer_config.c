...
xdc_Ptr ti_sysbios_family_arm_cc26xx_Timer_Object__create__S(xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb) __attribute__ ((externally_visible));
xdc_Void ti_sysbios_family_arm_cc26xx_Timer_Object__delete__S(xdc_Ptr instp) __attribute__ ((externally_visible));
xdc_Void ti_sysbios_family_arm_cc26xx_Timer_Object__destruct__S(xdc_Ptr objp) __attribute__ ((externally_visible));
